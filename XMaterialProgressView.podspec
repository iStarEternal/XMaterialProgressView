#
# Be sure to run `pod lib lint XMaterialProgressView.podspec' to ensure this is a
...
XMaterialCircleProgressView, XMaterialLinearProgressView
  ...
  s.source           = { :git => 'https://github.com/iStarEternal/XMaterialProgressView.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'XMaterialProgressView' => ['XMaterialProgressView/Assets/*.png']
  # }
